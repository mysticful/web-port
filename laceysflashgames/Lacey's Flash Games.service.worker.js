...
/** @type {string} */
const CACHE_PREFIX = 'Lacey's Flash Ga-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Lacey's Flash Games.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Lacey's Flash Games.html","Lacey's Flash Games.js","Lacey's Flash Games.offline.html","Lacey's Flash Games.icon.png","Lacey's Flash Games.apple-touch-icon.png","Lacey's Flash Games.audio.worklet.js","Lacey's Flash Games.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Lacey's Flash Games.wasm","Lacey's Flash Games.pck"];
